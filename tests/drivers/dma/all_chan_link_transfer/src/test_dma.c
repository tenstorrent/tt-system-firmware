...
__aligned(DMA_DATA_ALIGNMENT) static const char tx_data[] =
	"It is harder to be kind than to be wise........";
__aligned(DMA_DATA_ALIGNMENT) static char rx_data[RX_BUFF_SIZE] = {0};
__aligned(DMA_DATA_ALIGNMENT) static char rx_data2[RX_BUFF_SIZE] = {0};
