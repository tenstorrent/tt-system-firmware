...
{
	i3c_target_tx_write(i3c_dev, NULL, 8U, I3C_MSG_HDR_MODE0);
	return 0;
}
...
{
	LOG_INF("I3C Target: Read requested callback entered");
	target_prefill();
	return 0;
}
...
{
	LOG_INF("I3C Target: Read processed callback entered");
...
int main(void)
{
	...
	LOG_INF("I3C target registered successfully at address 0x%02x", i3c_target_config.address);
#endif
