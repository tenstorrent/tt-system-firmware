...
# ======== Board validation ========
# galaxy, galaxy_revc and galaxy_cf do not require a DMC image in bootfs
set(IS_GALAXY_BOARD FALSE)
if("${BOARD_REVISION}" STREQUAL "galaxy" OR "${BOARD_REVISION}" STREQUAL "galaxy_revc" OR
   "${BOARD_REVISION}" STREQUAL "galaxy_cf")
...
if(BOARD STREQUAL "tt_blackhole")
  ...
  elseif("${BOARD_REVISION}" STREQUAL "galaxy_cf")
    set(PROD_NAME "GALAXY_CF-1")
  else()
